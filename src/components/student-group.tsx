...
export function StudentGroup({ name, logo, description, socials = [], isDense = false }: StudentGroupType & { isDense?: boolean }) {
  ...
  return (
    <div className="flex max-w-full flex-col items-center justify-between gap-8 rounded-2xl bg-darkmode_regular p-8 md:max-w-[45%] lg:max-w-[31%]">
      <div className="flex w-full flex-col items-center gap-8">
        ...
        >
          <TypographyH3 className="w-full text-left md:text-center">{name}</TypographyH3>
